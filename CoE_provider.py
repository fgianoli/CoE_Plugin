...
from .CoE_algorithm import Lc
from .stratification import stratification



class convergenceProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(Lc())
        self.addAlgorithm(stratification())
    ...
    def name(self):
        ...
        """
        return self.tr('Convergence of Evidence')
